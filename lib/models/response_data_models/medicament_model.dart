 ...
 int? prix;
  ...
  Medicament({
    ...
    factory Medicament.fromMap(Map<String, dynamic> json) => Medicament(
      ...
      masse: json["masse"] as String?,
      marque: json["marque"] as String?,
      date_exp: json["date_exp"] == null ? null : DateTime.parse(json["date_exp"]),
      photo: json["get_image_url"] as String?,
      stock: json["qte_stock"] as int?,
      stockAlert: json["stockAlert"] as int?,
      stockOptimal: json["stockOptimal"] as int?,
      description: json["description"] as String?,
      posologie : json["posologie"] as String?,
      pharmaciename: json["get_pharmacie_name"] as String?,
      ...
      entrepot: json["entrepot"] as String?,
